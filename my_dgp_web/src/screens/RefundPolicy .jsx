...
const RefundPolicy = () => {
    return (
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p>Thank you for shopping at [Your Company Name]. If, for any reason, You are not completely satisfied with a purchase We invite You to review our policy on refunds and returns.</p>
            ...
            <p>The deadline for canceling an Order is 14 days from the date on which You received the Goods or on which a third party you have appointed, who is not the carrier, takes possession of the product delivered.</p>
            ...
            <p>[Your Company's Return Address]</p>

    ...
    return (
        <>
            ...
            <div className='static-page-container'>
                ...
                <p><strong>Website:</strong> <a href="https://mydgp.in" target="_blank" rel="noopener noreferrer">mydgp.in</a></p>
                ...
                <h2>Device Information We Collect</h2>
                <p>In order to provide a seamless and optimized experience, we may collect the following device-related information:</p>

                <h3>Location Data</h3>
                <p>GPS-based location data to offer relevant, location-specific services and enhance the overall functionality of our platform.</p>

                <h3>Phonebook Access</h3>
                <p>Permission to access contacts from your device to facilitate easy communication and sharing of services with your network.</p>

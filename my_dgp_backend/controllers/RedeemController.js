...
exports.getRedeemDetails = catchAsyncErrors(async (req, res, next) => {
  ...
  bookings.map((booking) => {
    ...
    todayEarnings += booking.totalPrice * 0.6; // giving 60% to service_provider for every booking
  ...
  bookings.map((booking) => {
    ...
    lastWeekEarnings += booking.totalPrice * 0.6; // giving 60% to service_provider for every booking
  ...
  bookings.map((booking) => {
    ...
    lastMonthEarnings += booking.totalPrice * 0.6; // giving 60% to service_provider for every booking
  ...
  bookings.map((booking) => {
    totalEarnings += booking.totalPrice * 0.6; // giving 60% to service_provider for every booking
